...
namespace Appli_gestion_cla.Controllers
{
    ...
    public class ClassesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nom_sale,Capacite_Max")] Classe classe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nom_sale,Capacite_Max")] Classe classe)
        {
            if (id != classe.Id)
            {
                return NotFound();
